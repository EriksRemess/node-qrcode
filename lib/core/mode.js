...
export function getBestModeForData(dataStr) {
  if (typeof dataStr !== 'string') return BYTE
...
export default { getCharCountIndicator, getBestModeForData, toString, isValid, from, NUMERIC, ALPHANUMERIC, BYTE, KANJI, MIXED };
